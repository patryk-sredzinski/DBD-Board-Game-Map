...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    downloadFormatTitle: 'Choose PDF format',
    downloadFormatA2: '1 page — A2',
    downloadFormatA2Desc: 'Single A2 landscape page (594 × 420 mm)',
    downloadFormat2xA3: '2 pages — A3',
    downloadFormat2xA3Desc: 'Two A3 portrait pages, left + right half — arrange side by side for A2',
    // Verification mode
    verificationMode: 'Distance checker',
    verificationModeHint: 'Click a room to see how many steps it takes to reach every other room',
  ...
  pl: {
    ...
    connectModeHint: 'Kliknij inną lokację, aby połączyć (Esc aby anulować)',
    ...
    validationExcessPropTiles: 'Za dużo elementów:',
    validationExcessPropTilesDesc: 'Niektóre typy elementów przekraczają maksymalną dozwoloną liczbę. Zmniejsz je do wymaganych ilości.',
    ...
    import: 'Importuj',
    roomColor: 'Kolor',
    downloadFormatTitle: 'Wybierz format PDF',
    downloadFormatA2: '1 strona — A2',
    downloadFormatA2Desc: 'Jedna strona A2 poziomo (594 × 420 mm)',
    downloadFormat2xA3: '2 strony — A3',
    downloadFormat2xA3Desc: 'Dwie strony A3 pionowo, lewa + prawa połowa — ułóż obok siebie, aby uzyskać A2',
    verificationMode: 'Sprawdzanie odległości',
    verificationModeHint: 'Kliknij lokację, aby zobaczyć ile kroków dzieli ją od pozostałych',
    verificationUnreachable: 'Nieosiągalny',
    sidebarActions: 'Akcje',
    sidebarLanguage: 'Język',
    sidebarHowToUse: 'Jak używać',
    sidebarInstructionDragRooms: 'Przeciągnij lokacje, aby zmienić ich pozycję na planszy',
    sidebarInstructionDragPaths: 'Przeciągnij ikony ścieżek, aby wygiąć trasę ścieżki',
    sidebarInstructionDragJoins: 'Przeciągnij punkty końcowe ścieżek, aby przesunąć je wokół krawędzi lokacji',
    sidebarInstructionRightClickRoom: 'Kliknij prawym przyciskiem na lokację, aby edytować jej właściwości',
    sidebarInstructionRightClickPath: 'Kliknij prawym przyciskiem na ścieżkę, aby zmienić jej kolor lub dodać nadkruszone ściany',
    sidebarInstructionClickName: 'Kliknij nazwę lokacji, aby ją zmienić',
    startSubtitle: 'Generator Map',
    startDescription: 'Twórz własne plansze do gry Dead by Daylight: The Board Game. Projektuj lokacje, łącz je ścieżkami i konfiguruj elementy rozgrywki.',
    startLoadExample: 'Załaduj przykładową mapę',
    startImportFile: 'Importuj plik mapy',
    startFresh: 'Zacznij od pustej planszy',
    startCredits: 'Podziękowania dla Karoliny, Dawida i Adriana \u2014 bez Waszych pomysłów ta plansza byłaby pusta. Zbudowane z pasji przez Patryka.',
  },
  fr: {
    ...
    connectModeHint: 'Cliquez sur une autre salle pour connecter (Échap pour annuler)',
    ...
    validationExcessPropTiles: 'Trop de tuiles de propriété:',
    validationExcessPropTilesDesc: 'Certains types de tuiles dépassent le nombre maximum autorisé. Réduisez-les pour correspondre aux quantités requises.',
    ...
    import: 'Importer',
    roomColor: 'Couleur',
    downloadFormatTitle: 'Choisir le format PDF',
    downloadFormatA2: '1 page — A2',
    downloadFormatA2Desc: 'Une seule page A2 paysage (594 × 420 mm)',
    downloadFormat2xA3: '2 pages — A3',
    downloadFormat2xA3Desc: 'Deux pages A3 portrait, moitié gauche + droite — disposez côte à côte pour A2',
    verificationMode: 'Vérification des distances',
    verificationModeHint: 'Cliquez sur une salle pour voir combien de pas il faut pour atteindre les autres',
    verificationUnreachable: 'Inaccessible',
    sidebarActions: 'Actions',
    ...
    sidebarInstructionDragPaths: 'Faites glisser les icônes de chemin pour courber l\'itinéraire',
    sidebarInstructionDragJoins: 'Faites glisser les extrémités des chemins pour les déplacer autour du bord de la salle',
    sidebarInstructionRightClickRoom: 'Clic droit sur une salle pour modifier ses propriétés',
    ...
    startSubtitle: 'Générateur de cartes',
    startDescription: 'Créez des plateaux de jeu personnalisés pour Dead by Daylight: The Board Game. Concevez des salles, reliez-les par des chemins et configurez tous les éléments de jeu.',
    ...
    startCredits: 'Merci à Karolina, Dawid et Adrian \u2014 sans vos idées, ce plateau serait vide. Construit avec passion par Patryk.',
  },
  de: {
    ...
    validationExcessPropTilesDesc: 'Einige Eigenschaftskachel-Typen überschreiten die maximal erlaubte Anzahl. Reduzieren Sie sie auf die erforderlichen Mengen.',
    ...
    import: 'Importieren',
    roomColor: 'Farbe',
    downloadFormatTitle: 'PDF-Format wählen',
    downloadFormatA2: '1 Seite — A2',
    downloadFormatA2Desc: 'Einzelne A2-Seite Querformat (594 × 420 mm)',
    downloadFormat2xA3: '2 Seiten — A3',
    downloadFormat2xA3Desc: 'Zwei A3-Seiten Hochformat, linke + rechte Hälfte — nebeneinander für A2 anordnen',
    verificationMode: 'Entfernungsprüfung',
    verificationModeHint: 'Klicken Sie auf einen Raum, um zu sehen, wie viele Schritte zu anderen Räumen nötig sind',
    verificationUnreachable: 'Unerreichbar',
    sidebarActions: 'Aktionen',
    sidebarLanguage: 'Sprache',
    sidebarHowToUse: 'Anleitung',
    sidebarInstructionDragRooms: 'Ziehen Sie Räume, um sie auf dem Spielbrett zu verschieben',
    ...
    sidebarInstructionRightClickPath: 'Rechtsklick auf einen Pfad, um seine Farbe zu ändern oder zerbrechliche Wände hinzuzufügen',
    sidebarInstructionClickName: 'Klicken Sie auf einen Raumnamen, um ihn umzubenennen',
    startSubtitle: 'Karten-Generator',
    startDescription: 'Erstellen Sie individuelle Spielbretter für Dead by Daylight: The Board Game. Entwerfen Sie Räume, verbinden Sie sie mit Pfaden und konfigurieren Sie alle Spielelemente.',
    startLoadExample: 'Beispielkarte laden',
    startImportFile: 'Kartendatei importieren',
    startFresh: 'Mit leerem Spielbrett starten',
    startCredits: 'Danke an Karolina, Dawid und Adrian \u2014 ohne eure Ideen wäre dieses Spielbrett leer. Mit Leidenschaft gebaut von Patryk.',
  },
  es: {
    ...
    initialPlacement: 'Colocación inicial',
    ...
    validationExcessPropTilesDesc: 'Algunos tipos de losetas exceden el número máximo permitido. Redúcelos para que coincidan con las cantidades requeridas.',
    ...
    import: 'Importar',
    roomColor: 'Color',
    downloadFormatTitle: 'Elegir formato PDF',
    downloadFormatA2: '1 página — A2',
    downloadFormatA2Desc: 'Una página A2 horizontal (594 × 420 mm)',
    downloadFormat2xA3: '2 páginas — A3',
    downloadFormat2xA3Desc: 'Dos páginas A3 vertical, mitad izquierda + derecha — colocar lado a lado para A2',
    verificationMode: 'Verificar distancias',
    verificationModeHint: 'Haz clic en una sala para ver cuántos pasos se necesitan para llegar a las demás',
    verificationUnreachable: 'Inaccesible',
    sidebarActions: 'Acciones',
    sidebarLanguage: 'Idioma',
    sidebarHowToUse: 'Cómo usar',
    sidebarInstructionDragRooms: 'Arrastra las salas para reposicionarlas en el tablero',
    sidebarInstructionDragPaths: 'Arrastra los íconos de camino para curvar la ruta',
    ...
    sidebarInstructionRightClickPath: 'Clic derecho en un camino para cambiar su color o añadir paredes rompibles',
    sidebarInstructionClickName: 'Haz clic en el nombre de una sala para renombrarla',
    startSubtitle: 'Generador de mapas',
    startDescription: 'Crea tableros de juego personalizados para Dead by Daylight: The Board Game. Diseña salas, conéctalas con caminos y configura todos los elementos del juego.',
    startLoadExample: 'Cargar mapa de ejemplo',
    startImportFile: 'Importar archivo de mapa',
    startFresh: 'Empezar con tablero vacío',
    startCredits: 'Gracias a Karolina, Dawid y Adrian \u2014 sin vuestras ideas este tablero estaría vacío. Construido con pasión por Patryk.',
  },
};
