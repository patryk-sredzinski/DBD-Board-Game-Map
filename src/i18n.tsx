...
const translations: Record<Lang, Record<string, string>> = {
  ...
  pl: {
    ...
    clearGameBoardConfirm: 'Czy na pewno chcesz wyczyścić całą planszę? Spowoduje to usunięcie wszystkich lokacji, ścieżek i tła.',
  ...
  fr: {
    ...
    clearGameBoardConfirm: 'Êtes-vous sûr de vouloir effacer tout le plateau? Cela supprimera toutes les salles, chemins et l\'arrière-plan.',
  ...
  de: {
    ...
    clearGameBoardConfirm: 'Sind Sie sicher, dass Sie das gesamte Spielbrett leeren möchten? Alle Räume, Pfade und der Hintergrund werden entfernt.',
  ...
  es: {
    ...
    clearGameBoardConfirm: '¿Estás seguro de que quieres limpiar todo el tablero? Esto eliminará todas las salas, caminos y el fondo.',
